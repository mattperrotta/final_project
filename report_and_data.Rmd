...
base_fit <- flu_data %>%
  filter(fluregion == 'North America') %>% 
  lm(a_total ~ week + sin_f1 + cos_f1, data = ., na.action = na.exclude)
...
=======
flu_fitted %>% 
>>>>>>> 9a0cdf72b2a5e4d8e1c0ddbf1e914066b98d665e
  filter(year == '2008') %>% 
...
=======
flu_orginal = flu_data %>% 
  filter(fluregion == 'North America') %>% 
  flum(model = "fluserf", outc = a_total, time = edate)
>>>>>>> 9a0cdf72b2a5e4d8e1c0ddbf1e914066b98d665e
```
