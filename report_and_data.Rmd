...
#  filter(year == '2008') %>% 
  ...
  filter(year == '2008') %>% 
  ggplot(aes(x = week, y = a_total, color = 'Inf A Cases')) +
>>>>>>> 2c866f25ba8edd6e2749519741168491d17da3ee
  geom_line() +
  geom_line(aes(x = epiweek, y = y0_ul, color = "red")) 
```
<<<<<<< HEAD
